...
if sys.version_info[0] >= 3:
    ...
    from urllib.request import (urlopen, urlretrieve, Request, install_opener, build_opener, HTTPCookieProcessor)
    import http.cookiejar as cookielib
else:
    from urllib2 import (HTTPError, URLError, urlopen, Request, build_opener, install_opener, HTTPCookieProcessor)
...
def getLocWeer(iscity=None):
    ...
    try:
        ...
        req = Request("https://location.buienradar.nl/1.1/location/search?query=" + citynamenewy, data=None, headers=headers)
        ...
        req = Request("https://forecast.buienradar.nl/2.0/forecast/" + str(staddata[entryselect]["id"]), data=None, headers=headers)
        handler = urlopen(req, timeout=15)
        antw = handler.read()
        ...
        try:
            ...
            opener = build_opener(HTTPCookieProcessor(cookie_jar))
            install_opener(opener)
            req = Request("http://api.buienradar.nl/data/forecast/1.1/all/" + str(citynumb), data=None, headers=headers)
            handler = urlopen(req, timeout=15)
            antw = handler.read()
            # add Lululla edit end
            weatherData = json.loads(antw)
        ...
        if sz_w > 1800:
            for day in range(0, 7):
                ...
                dayinfoblok += """
                    ...
                    <widget render="Label" foregroundColor="yellow" source="smallday2""" + str(day) + """" position=\"""" + str(138 + (248 * day)) + """,461" size="135,40" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;34" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" foregroundColor="listRecording" source="maxtemp2""" + str(day) + """" position=\"""" + str(130 + (248 * day)) + """,560" size="90,54" zPosition="3" font="NotoSans-Bold;48" transparent="1" shadowColor="black" shadowOffset="-2,-2" />
                    <widget render="Label" source="minitemp2""" + str(day) + """" position=\"""" + str(240 + (248 * day)) + """,576" size="90,36" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;28" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" foregroundColor="green" source="weertype2""" + str(day) + """" position=\"""" + str(105 + (248 * day)) + """,612" size="220,95" zPosition="3" valign="center" halign="center" font="NotoSans-Bold;24" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" foregroundColor="yellow" source="sunriselab" position="640,362" size="200,40" zPosition="3" font="NotoSans-Bold;28" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
            ...
            for uur in range(0, 8):
                dayinfoblok += """
                    <widget render="Label" foregroundColor="listRecording" source="dayhour3""" + str(uur) + """" position=\"""" + str(195 + (216 * uur)) + """,757" size="90,36" zPosition="3" valign="center" halign="right" font="NotoSans-Bold;28" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="daytemp3""" + str(uur) + """" position=\"""" + str(120 + (216 * uur)) + """,820" size="180,54" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;48" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" foregroundColor="green" source="sunpercent3""" + str(uur) + """" position=\"""" + str(168 + (216 * uur)) + """,883" size="123,32" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;27" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="daypercent3""" + str(uur) + """" position=\"""" + str(168 + (216 * uur)) + """,922" size="120,30" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;27" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" foregroundColor="listRecording" source="hrdayper3""" + str(uur) + """" position=\"""" + str(168 + (216 * uur)) + """,961" size="123,32" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;27" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" foregroundColor="yellow" source="dayspeed3""" + str(uur) + """" position=\"""" + str(168 + (216 * uur)) + """,1000" size="123,32" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;27" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
            ...
            skin = """
                    ...
                    <widget source="global.CurrentTime" foregroundColor="listRecording" render="Label" position="1624,35" size="225,45" transparent="1" zPosition="1" font="NotoSans-Bold;36" valign="center" halign="right"><convert type="ClockToText">Format:%-H:%M</convert></widget>
                    <widget source="global.CurrentTime" foregroundColor="green" render="Label" position="1399,72" size="450,35" transparent="1" zPosition="1" font="NotoSans-Bold;24" valign="center" halign="right"><convert type="ClockToText">Format:%a %d/%m/%y</convert></widget>
                    <widget name="yellowdot" position="275,462" size="36,36" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/"""+icoonpath+"""/buttons/yeldothd.png" zPosition="3" alphatest="blend"/>
                    <widget render="Label" foregroundColor="listRecording" source="city1" position="608,44" size="705,64" zPosition="3" valign="center" halign="center" font="NotoSans-Bold;48" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="bigtemp1" position="870,122" size="353,118" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;108" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" foregroundColor="listRecording" source="bigweathertype1" position="870,298" size="480,40" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;28" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="GevoelsTemp1" position="870,250" size="354,40" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;28" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" foregroundColor="green" source="winddir1" position="870,346" size="345,40" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;28" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>""" + peocpichd + dayinfoblok + """
            ...
            for day in range(0, 7):
                ...
                dayinfoblok += """
                    ...
                    <widget render="Label" foregroundColor="yellow" source="smallday2""" + str(day) + """" position=\"""" + str(92 + (165 * day)) + """,308" size="90,24" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;22" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" foregroundColor="listRecording" source="maxtemp2""" + str(day) + """" position=\"""" + str(92 + (165 * day)) + """,382" size="60,36" zPosition="3" font="NotoSans-Bold;32" transparent="1" shadowColor="black" shadowOffset="-2,-2" />
                    <widget render="Label" source="minitemp2""" + str(day) + """" position=\"""" + str(160 + (165 * day)) + """,395" size="32,22" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;18" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" foregroundColor="listRecording" source="weertype2""" + str(day) + """" position=\"""" + str(77 + (165 * day)) + """,416" size="138,44" zPosition="3" valign="center" halign="center" font="NotoSans-Bold;16" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" foregroundColor="green" source="sunriselab" position="416,248" size="200,40" zPosition="3" font="NotoSans-Bold;18" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
            ...
            for uur in range(0, 8):
                dayinfoblok += """
                    <widget render="Label" foregroundColor="listRecording" source="dayhour3""" + str(uur) + """" position=\"""" + str(125 + (144 * uur)) + """,506" size="80,24" zPosition="3" valign="center" halign="right" font="NotoSans-Bold;22" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="daytemp3""" + str(uur) + """" position=\"""" + str(80 + (144 * uur)) + """,540" size="120,36" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;32" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="sunpercent3""" + str(uur) + """" position=\"""" + str(112 + (144 * uur)) + """,580" size="82,21" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;18" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="daypercent3""" + str(uur) + """" position=\"""" + str(112 + (144 * uur)) + """,606" size="80,20" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;18" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="hrdayper3""" + str(uur) + """" position=\"""" + str(112 + (144 * uur)) + """ ,632" size="80,20" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;18" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="dayspeed3""" + str(uur) + """" position=\"""" + str(112 + (144 * uur)) + """,658" size="82,21" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;18" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
            ...
            skin = """
                    ...
                    <widget source="global.CurrentTime" foregroundColor="listRecording" render="Label" position="1081,12" size="150,55" transparent="1" zPosition="1" font="NotoSans-Bold;24" valign="center" halign="right"><convert type="ClockToText">Format:%-H:%M</convert></widget>
                    <widget source="global.CurrentTime" foregroundColor="green" render="Label" position="931,32" size="300,55" transparent="1" zPosition="1" font="NotoSans-Bold;16" valign="center" halign="right"><convert type="ClockToText">Format:%a %d/%m/%y</convert></widget>
                    <widget name="yellowdot" position="184,303" size="24,24" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/"""+icoonpath+"""/buttons/yeldot.png" zPosition="3" alphatest="blend"/>
                    <widget render="Label" foregroundColor="listRecording" source="city1" position="405,37" size="470,42" zPosition="3" valign="center" halign="center" font="NotoSans-Bold;32" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" foregroundColor="listRecording" source="bigtemp1" position="565,88" size="235,76" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;72" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="bigweathertype1" position="565,208" size="320,30" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;18" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="GevoelsTemp1" position="565,176" size="236,30" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;18" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="winddir1" position="565,240" size="230,30" zPosition="3" valign="center" halign="left" font="NotoSans-Bold;18" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>""" + peocpicsd + dayinfoblok + """
        ...
        if sz_w > 1800:
            ...
            for day in range(0, len(dataDagen)):
                ...
                if day < 13:
                    ...
                    dayinfoblok += """
                    <widget render="Label" source="regenval""" + str(day) + """" position=\"""" + str((134 + (118 * day))+0) + """,600" size="118,54" valign="center" halign="center" zPosition="20" font="NotoSans-Bold;25" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="windspeed""" + str(day) + """" position=\"""" + str((134 + (118 * day))+0) + """,435" size="118,54" valign="center" halign="center" zPosition="20" font="NotoSans-Bold;25" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="regenvalunit""" + str(day) + """" position=\"""" + str((134 + (118 * day))+0) + """,600" size="118,54" valign="center" halign="center" zPosition="20" font="NotoSans-Bold;30" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    ...
                    <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/"""+icoonpath+"""/lines/rdot.png" position=\"""" + str(((130 + (118 * day))+59)-12) + ""","""+str((((yposline)+lineheight)-12))+"""\" size="25,25" zPosition="10" transparent="0" alphatest="blend"/><widget name="bigWeerIcon1""" + str(day) + """" position=\"""" + str((130 + (118 * day))+28) + """,267" size="72,72" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/"""+icoonpath+"""/iconhd/""" + str(dagenbefore["iconcode"]) + """.png" zPosition="1" alphatest="blend"/>
                    ...
                    <widget render="Label" source="dagvandeweek""" + str(day) + """" position=\"""" + str((134 + (118 * day))+0) + """,155" size="118,54" valign="center" halign="center" zPosition="15" font="NotoSans-Bold;45" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="datumvandeweek""" + str(day) + """" position=\"""" + str((134 + (118 * day))+0) + """,195" size="118,54" valign="center" halign="center" zPosition="15" font="NotoSans-Bold;30" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="linetempmax""" + str(day) + """" position=\"""" + str(((130 + (118 * day))-15)+59) + ""","""+str(((yposline-45)+lineheight))+"""\" size="90,54" zPosition="15" font="NotoSans-Bold;30" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="linetempmin""" + str(day) + """" position=\"""" + str(((130 + (118 * day))-15)+59) + ""","""+str((yposlinecold+15)+lineheightcold)+"""\" size="90,54" zPosition="15" font="NotoSans-Bold;30" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    """
            skin = """
                    ...
                    <widget source="global.CurrentTime" foregroundColor="listRecording" render="Label" position="1624,35" size="225,45" transparent="1" zPosition="1" font="NotoSans-Bold;36" valign="center" halign="right"><convert type="ClockToText">Format:%-H:%M</convert></widget>
                    <widget source="global.CurrentTime" foregroundColor="green" render="Label" position="1400,74" size="450,37" transparent="1" zPosition="1" font="NotoSans-Bold;24" valign="center" halign="right"><convert type="ClockToText">Format:%a %d/%m/%y</convert></widget>
                    <widget render="Label" source="city1" foregroundColor="green" position="608,44" size="705,64" zPosition="3" valign="center" halign="center" font="NotoSans-Bold;48" transparent="1" />
                    """ + dayinfoblok + """
                    </screen>"""
            ...
            for day in range(0, len(dataDagen)):
                ...
                dayinfoblok += """
                    <widget render="Label" source="regenval""" + str(day) + """" position=\"""" + str((87 + (79 * day))+0) + """,400" size="79,36" valign="center" halign="center" zPosition="20" font="NotoSans-Bold;17" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="windspeed""" + str(day) + """" position=\"""" + str((87 + (79 * day))+0) + """,290" size="79,36" valign="center" halign="center" zPosition="20" font="NotoSans-Bold;20" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="regenvalunit""" + str(day) + """" position=\"""" + str((87 + (79 * day))+0) + """,400" size="79,36" valign="center" halign="center" zPosition="20" font="NotoSans-Bold;20" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    ...
                    <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/"""+icoonpath+"""/linessd/bdot.png" position=\"""" + str(((87 + (79 * day))+39)-8) + ""","""+str(((yposlinecold)+lineheightcold)-8)+"""\" size="18,18" zPosition="10" transparent="0" alphatest="blend"/>
                    ...
                    <widget render="Label" source="dagvandeweek""" + str(day) + """" position=\"""" + str((87 + (79 * day))+0) + """,103" size="79,36" valign="center" halign="center" zPosition="15" font="NotoSans-Bold;30" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="datumvandeweek""" + str(day) + """" position=\"""" + str((87 + (79 * day))+0) + """,130" size="79,36" valign="center" halign="center" zPosition="15" font="NotoSans-Bold;20" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="linetempmax""" + str(day) + """" position=\"""" + str(((103 + (79 * day))-10)+26) + ""","""+str(((yposline-35)+lineheight))+"""\" size="60,36" zPosition="15" font="NotoSans-Bold;20" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    <widget render="Label" source="linetempmin""" + str(day) + """" position=\"""" + str(((106 + (79 * day))-10)+26) + ""","""+str((yposlinecold+10)+lineheightcold)+"""\" size="60,36" zPosition="15" font="NotoSans-Bold;20" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                    """
            skin = """
                    <screen name="fourteen" position="0,0" size="1280,720" title="fourteen">
                    ...
                    <widget source="global.CurrentTime" foregroundColor="listRecording" render="Label" position="1081,12" size="150,55" transparent="1" zPosition="1" font="NotoSans-Bold;24" valign="center" halign="right"><convert type="ClockToText">Format:%-H:%M</convert></widget>
                    <widget source="global.CurrentTime" foregroundColor="green" render="Label" position="931,32" size="300,55" transparent="1" zPosition="1" font="NotoSans-Bold;16" valign="center" halign="right"><convert type="ClockToText">Format:%a %d/%m/%y</convert></widget>
                    <widget render="Label" source="city1" foregroundColor="green" position="406,30" size="470,43" zPosition="3" valign="center" halign="center" font="NotoSans-Bold;32" transparent="1" />
                    """ + dayinfoblok + """
                    </screen>"""
            # for day in range(0, 14):
            for day in range(0, len(dataDagen)):
    ...
    def __init__(self, session):
        if sz_w > 1800:
            skin = """
				...
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/Images/bgbluhd.png" position="0,0" size="1920,1080" zPosition="-100"/>
                ...
                <widget source="global.CurrentTime" foregroundColor="listRecording" render="Label" position="1624,35" size="225,45" transparent="1" zPosition="3" font="NotoSans-Bold;36" valign="center" halign="right"><convert type="ClockToText">Format:%-H:%M</convert></widget>
                <widget source="global.CurrentTime" foregroundColor="green" render="Label" position="1399,74" size="450,37" transparent="1" zPosition="3" font="NotoSans-Bold;24" valign="center" halign="right"><convert type="ClockToText">Format:%a %d/%m/%y</convert></widget>
                <widget source="session.VideoPicture" render="Pig" position="30,180" size="720,405" backgroundColor="#ff000000" zPosition="1"/>
                <widget source="session.CurrentService" render="Label" position="60,125" size="720,30" zPosition="1" foregroundColor="green" transparent="1" font="NotoSans-Bold;28" noWrap="1" valign="center" halign="center"><convert type="ServiceName">Name</convert></widget>
                <widget name="list" position="840,225" foregroundColor="green" size="900,630" scrollbarMode="showOnDemand" selectionPixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/"""+icoonpath+"""/list/list97563.png"/>\n
                ...
                <widget name="key_red" foregroundColor="listRecording" position="242,1015" size="370,42" zPosition="1" font="NotoSans-Bold;40" halign="left" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                ...
                <widget name="key_green" foregroundColor="green" position="678,1015" size="370,42" zPosition="1" font="NotoSans-Bold;40" halign="left" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                ...
                <widget name="key_yellow" foregroundColor="yellow" position="1114,1015" size="370,42" zPosition="1" font="NotoSans-Bold;40" halign="left" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                ...
                <widget name="key_blue" foregroundColor="mediumblue" position="1550,1015" size="370,42" zPosition="1" font="NotoSans-Bold;40" halign="left" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                <widget name="favor" foregroundColor="cyan1" position="85,45" size="1085,55" valign="center" halign="left" zPosition="1" font="NotoSans-Bold;36" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                <widget name="plaatsn" foregroundColor="green" position="860,135" size="375,70" valign="center" halign="left" zPosition="1" font="NotoSans-Bold;63" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                </screen>"""
            ...
            skin = """
                ...
                <widget source="global.CurrentTime" foregroundColor="listRecording" render="Label" position="1081,12" size="150,55" transparent="1" zPosition="1" font="NotoSans-Bold;24" valign="center" halign="right"><convert type="ClockToText">Format:%-H:%M</convert></widget>
                <widget source="global.CurrentTime" foregroundColor="green" render="Label" position="931,32" size="300,55" transparent="1" zPosition="1" font="NotoSans-Bold;16" valign="center" halign="right"><convert type="ClockToText">Format:%a %d/%m/%y</convert></widget>
                <widget source="session.VideoPicture" render="Pig" position="85,130" size="417,243" backgroundColor="#ff000000" zPosition="1"/>
                <widget source="session.CurrentService" render="Label" position="85,89" size="417,20" zPosition="1" foregroundColor="green" transparent="1" font="NotoSans-Bold;28" noWrap="1" valign="center" halign="center"><convert type="ServiceName">Name</convert></widget>
                <widget name="list" position="630,156" foregroundColor="green" size="650,250" scrollbarMode="showOnDemand" selectionPixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/"""+icoonpath+"""/list/list65043.png"/>\n
                ...
                <widget name="key_red" position="185,663" size="220,28" zPosition="1" font="NotoSans-Bold;24" halign="left" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                ...
                <widget name="key_green" position="460,663" size="220,28" zPosition="1" font="NotoSans-Bold;24" halign="left" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                ...
                <widget name="key_yellow" foregroundColor="yellow0" position="735,663" size="220,28" zPosition="1" font="NotoSans-Bold;24" halign="left" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                ...
                <widget name="key_blue" foregroundColor="mediumblue" position="1010,663" size="220,28" zPosition="1" font="NotoSans-Bold;24" halign="left" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                <widget name="favor" foregroundColor="cyan1" position="57,30" size="723,37" valign="center" halign="left" zPosition="1" font="NotoSans-Bold;24" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                <widget name="plaatsn" foregroundColor="green" position="630,90" size="250,47" valign="center" halign="left" zPosition="1" font="NotoSans-Bold;42" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                </screen>"""
...
class infoscreen(Screen):
    def __init__(self, session):
        if sz_w > 1800:
            skin = """
                    <screen name="startScreen" position="center,center" size="1920,1080" title="Weather Plugin">
					<eLabel text="The Weather help" position="32,13" size="window_title_size" font="font_window_title" backgroundColor="windowBackground" transparent="1" foregroundColor="cyan1" />
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/Images/bgbluhd.png" position="0,0" size="1920,1080" zPosition="-100"/>
                <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/"""+icoonpath+"""/borders/smallline3.png" position="0,112" size="1920,3" zPosition="1"/>
                <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/"""+icoonpath+"""/borders/smallline3.png" position="0,1010" size="1920,3" zPosition="1"/>
                <widget source="global.CurrentTime" render="Label" foregroundColor="listRecording" position="1624,35" size="225,45" transparent="1" zPosition="3" font="NotoSans-Bold;36" valign="center" halign="right"><convert type="ClockToText">Format:%-H:%M</convert></widget>
                <widget source="global.CurrentTime" render="Label" foregroundColor="green" position="1399,74" size="450,37" transparent="1" zPosition="3" font="NotoSans-Bold;24" valign="center" halign="right"><convert type="ClockToText">Format:%a %d/%m/%y</convert></widget>
                <widget source="session.VideoPicture" render="Pig" position="30,160" size="720,405" backgroundColor="#ff000000" zPosition="1"/>
                <widget source="session.CurrentService" render="Label" position="30,125" size="720,30" zPosition="1" foregroundColor="green" transparent="1" font="NotoSans-Bold;28" noWrap="1" valign="center" halign="center"><convert type="ServiceName">Name</convert></widget>
                <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/"""+icoonpath+"""/buttons/red34.png" position="192,1022" size="34,34" alphatest="blend"/>
                <widget name="key_red" foregroundColor="listRecording" position="242,1015" size="370,42" zPosition="1" font="NotoSans-Bold;40" halign="left" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/"""+icoonpath+"""/buttons/green34.png" position="628,1022" size="34,34" alphatest="on"/>
                <widget name="key_green" foregroundColor="green" position="678,1020" size="370,42" zPosition="1" font="NotoSans-Bold;40" halign="left" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/"""+icoonpath+"""/buttons/yellow34.png" position="1064,1022" size="34,34" alphatest="on"/>
                <widget name="key_yellow" foregroundColor="yellow" position="1114,1020" size="370,42" zPosition="1" font="NotoSans-Bold;40" halign="left" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                <widget name="helpinfo" foregroundColor="green" position="980,70" size="800,600" valign="center" halign="left" zPosition="1" font="NotoSans-Bold;36" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                <widget name="version" position="1350,945" foregroundColor="listRecording" size="600,42" valign="center" halign="left" zPosition="1" font="NotoSans-Bold;36" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                </screen>"""
        else:
            skin = """
                <screen name="startScreen" position="center,center" size="1280,720" title="Weather Plugin">
                ...
                <widget source="global.CurrentTime" render="Label" position="1081,12" size="150,55" transparent="1" zPosition="1" font="NotoSans-Bold;24" valign="center" foregroundColor="listRecording" halign="right"><convert type="ClockToText">Format:%-H:%M</convert></widget>
                <widget source="global.CurrentTime" render="Label" position="931,32" size="300,55" transparent="1" zPosition="1" font="NotoSans-Bold;16" valign="center" foregroundColor="green" halign="right"><convert type="ClockToText">Format:%a %d/%m/%y</convert></widget>
                <widget source="session.VideoPicture" render="Pig" position="85,110" size="417,243" backgroundColor="#ff000000" zPosition="1"/>
                <widget source="session.CurrentService" render="Label" position="85,89" size="417,20" zPosition="1" foregroundColor="green" transparent="1" font="NotoSans-Bold;28" noWrap="1" valign="center" halign="center"><convert type="ServiceName">Name</convert></widget>
                <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/"""+icoonpath+"""/buttons/red26.png" position="145,663" size="26,26" alphatest="blend"/>
                <widget name="key_red" foregroundColor="listRecording" position="185,663" size="220,28" zPosition="1" font="NotoSans-Bold;24" halign="left" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/"""+icoonpath+"""/buttons/green26.png" position="420,663" size="26,26" alphatest="blend"/>
                <widget name="key_green" position="460,663" foregroundColor="green" size="220,28" zPosition="1" font="NotoSans-Bold;24" halign="left" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TheWeather/"""+icoonpath+"""/buttons/yellow26.png" position="695,663" size="26,26" alphatest="blend"/>
                <widget name="key_yellow" foregroundColor="yellow" position="735,663" size="220,28" zPosition="1" font="NotoSans-Bold;24" halign="left" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                <widget name="helpinfo" foregroundColor="green" position="720,150" size="400,320" valign="center" halign="left" zPosition="1" font="NotoSans-Bold;24" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                <widget name="version" foregroundColor="listRecording" position="920,590" size="400,28" valign="center" halign="left" zPosition="1" font="NotoSans-Bold;24" backgroundColor="#000000" transparent="1" shadowColor="black" shadowOffset="-2,-2"/>
                </screen>"""
    ...
    def default(self):
        file = open("/etc/enigma2/iconpack.cfg", "w")
        file.write("Images")
        file.close()
        # icoonpath = "Images"
...
def main(session, **kwargs):
    ...
    if checkInternet():
        ...
        locdirsave = "/etc/enigma2/iconpack.cfg"
        if os.path.exists(locdirsave):
            for line in open(locdirsave):
